...
const FoodDeliveryApp = () =>  {
    ...
    const fetchData = async () => {
        ...
        // https://www.swiggy.com/dapi/restaurants/list/v5?lat=17.5164593&lng=78.4176358&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING
        ...
        const parsedData = jsonData?.data?.cards[2]?.card?.card?.gridElements?.infoWithStyle?.restaurants
